                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                {{ FORM::select('faculty_id',$faculty+[0=>'Zgjedh fakultetin'],0,['class'=>'form-control','required','id'=>'faculty_id']) }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                {{ FORM::select('faculty_id',$faculty+[0=>'Zgjedh fakultetin'],null,['class'=>'form-control','required', 'id'=>'faculty_id']) }}
                            </div>
                        </div>
                    </div>
                </div>
