...
@section('other')
    <script src="{{asset('js/CPA_LUSH.js')}}"></script>
    @stop
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ FORM::open(['class'=>'form-horizontal form-label-left input_mask','id'=>'register-form', 'url'=>'cpalushRegister']) }}
                    <div class="col-md-10 col-md-offset-1">
                        <div class="form-group">
                            {{ FORM::label('Thirrja mësimore',null,['class'=>'control-label col-md-4 col-sm-4 col-xs-12']) }}
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                {{FORM::select('cpa_id',[0=>'Cakto thirrjen mësimore']+$cpas,0,['class'=>'form-control','required','id'=>'cpa_id'])}}
                            </div>
                        </div>
                        <div class="form-group">
                            {{ FORM::label('Ligjëratë/Ushtrime',null,['class'=>'control-label col-md-4 col-sm-4 col-xs-12']) }}
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                {{FORM::select('lush_id',[0=>'Cakto ligjëratë/ushtrime']+$lush,0,['class'=>'form-control','required','id'=>'cpa_id'])}}
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="editModal" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ FORM::open(['class'=>'form-horizontal form-label-left input_mask', 'method'=>'PATCH','id'=>'edit-form']) }}
                    <div class="col-md-10 col-md-offset-1">
                        <div class="form-group">
                            {{ FORM::label('Thirrja mësimore',null,['class'=>'control-label col-md-4 col-sm-4 col-xs-12']) }}
                            <div class="col-md-8 col-sm-8 col-xs-12">
                        ...
                        <div class="form-group">
                            {{ FORM::label('Ligjëratë/Ushtrime',null,['class'=>'control-label col-md-4 col-sm-4 col-xs-12']) }}
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                {{FORM::select('lush_id',[0=>'Cakto ligjëratë/ushtrime']+$lush,0,['class'=>'form-control','required','id'=>'lush_id'])}}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <table class="table table-striped projects">
                        <thead>
                        <tr>
                            <th style="width: 40%">Thirrja Mësimore</th>
                            <th style="width: 40%">Ligjëratë/Ushtrime</th>
                        ...
                        @forelse($data as $value)
                            <tr>
                                ...
                                <td>{{ $value->lush }}</td>
                                <td>
                                    <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-cpa_id="{{$value->cpa_id}}" data-target="#editModal" data-lush_id="{{$value->lush_id}}"><i class="fa
                                    fa-pencil"></i>
                                        Ndrysho
                                    </button>
                                    <button type="button" class="btn btn-danger btn-xs" data-cpa_id="{{$value->cpa_id}}" data-lush_id="{{$value->lush_id}}" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash-o"></i> Fshij
                                    </button>
                                </td>
                            </tr>
                        @empty
